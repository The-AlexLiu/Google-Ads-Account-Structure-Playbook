...
用于梳理一个 Google Ads 电商账户是否应该拆 campaign，以及每个 campaign 的职责是否清楚。
...
| Campaign | Type | Budget | Bidding | Conversions | Cost | ROAS | 主要问题 |
|---|---|---:|---|---:|---:|---:|---|
|  |  |  |  |  |  |  |  |

## 3. 推荐结构

| Campaign | 角色 | 预算占比 | 判断指标 |
|---|---|---:|---|
...
| 是否需要拆分 | 判断标准 | 结论 |
|---|---|---|
| 品牌 / 非品牌拆分 | 是否需要分开看品牌防守和新增需求 | 待判断 |
| 按产品线拆 | AOV、毛利、页面、搜索意图是否明显不同 | 待判断 |
